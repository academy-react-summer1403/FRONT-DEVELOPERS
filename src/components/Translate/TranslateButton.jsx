...
const Lg = () => {
  ...
  return (
    <div className="group relative">
      ...
      <div
        className="hidden group-hover:block absolute bg-white rounded-lg -left-8
       shadow-md text-sm grid p-4 justify-items-center font-normal"
      >
        <button
          className={`cursor-pointer w-full rounded-full block px-2 py-1 my-1 hover:bg-green/40 ${
            l === "1" ? "bg-green/40" : ""
          }`}
          onClick={() => (
        ...
        <button
          ...
          onClick={() => (
            handleLanguageChange("2", TranslateSlice.actions.toggleLanguage2),
            setL1("fa")
          )}
        >
          فارسی
        ...
        <button
          ...
          onClick={() =>
            handleLanguageChange(
              "3",
              TranslateSlice.actions.toggleLanguage3,
              setL1("es")
            )
          }
        >
        ...
        <button
          ...
          onClick={() => (
            handleLanguageChange("4", TranslateSlice.actions.toggleLanguage4),
            setL1("tr")
          )}
        >
          Türkçe
