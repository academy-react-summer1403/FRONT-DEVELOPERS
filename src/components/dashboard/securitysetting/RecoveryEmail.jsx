...
import { useGetConfigValue, useGetSendValue } from "../../../core/services/query/queries";
...
const RecoveryEmail = () => {
  ...
  const params = { SendValue: id };
  const getConfigValue = useGetSendValue(params);
  ...
  const validation = yup.object().shape({
    ...
    confrim: yup
      ...
      .oneOf(
        ...
        'Must match "newPassword" field value'
      )
