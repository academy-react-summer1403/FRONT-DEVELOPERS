    ...
    <>
      ...
      >
        <div>
          {/* Body  */}
          <div
            className="grid grid-cols-2 gap-1  my-8
                max-xl:grid-cols-1
          ...
          >
            <div className="text-right text-xs grid-col-1 text-gray-400 max-md:mx-auto pl-[50px]">
              <label className="relative">
                ...
                {/* show/hide icon  */}
                <i
                  onClick={() => setShowHideNewPassword(!showHideNewPassword)}
            ...
            <div className="text-right text-xs grid-col-1 text-gray-400 max-md:mx-auto pr-[240px]">
              <label className="relative">
                ...
                {/* show/hide icon  */}
                <i
                  onClick={() => setShowHidePrevPassword(!showHidePrevPassword)}
                  className="absolute right-6 top-[55px]"
                >
                  {showHidePrevPassword ? (
                    <IoEyeOutline className="text-green" />
                  ) : (
                    <FaRegEyeSlash className="text-green" />
                  )}
                ...
                <input
                  ...
                  type={showHidePrevPassword ? "text" : "password"}
          ...
          <button
            type="submit"
            className="flex flex-row gap-2 mx-auto text-sm text-green rounded-full
