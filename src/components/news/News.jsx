...
const News = () => {
  return (
    ...
    {/* text section  */}
        ...
        <h1 className='font-bold text-center text-black text-2xl '> اخبار و مقالات </h1>
          <p className=' text-sm text-gray-400  text-center mt-5'>! خـــودت رو با خـــبر کن </p>
          
        </div>

    {/* body section  */}
        <div className='flex-1 justify-center items-center h-[400px] w-[1100px] mt-[30px] '>
            <div className='w-full h-full  flex flex-row justify-center items-center mx-auto gap-5'>

                <div className='w-1/2 h-full  flex flex-col gap-2'>
                    <div className='flex flex-row items-start w-full h-[60%] gap-5'>
                        <div className='w-1/2 h-[90%]   '><img src={Img1} alt="" className='w-full h-full '/></div>
                        <div className='w-1/2 h-[90%]  '><img src={Img2} alt="" className='w-full h-full'/></div>
                    </div>
                    <div className='w-full h-[43%]   '><img src={Img4} alt="" className='w-full h-full '/></div>
                ...
                <div className='w-1/2 h-full  flex flex-col gap-2'>
                  <div className='w-full h-[43%]  '><img src={Img3} alt="" className='w-full h-full'/></div>
                  <div className=' flex flex-row items-end w-full h-[60%]  gap-5'>
                    <div className='w-1/2 h-[90%]  '><img src={Img5} alt="" className='w-full h-full' /></div>
                     <div className='w-1/2 h-[90%]  '><img src={Img6} alt="" className='w-full h-full'/></div>
