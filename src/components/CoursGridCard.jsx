          ...
          <div className="relative top-[-10px]">
                ...
                <h3 className="  flex h-full items-center gap-1 text-[16px] max-md:text-[14px] font-normal font-Yekan text-[#888888]">
                  ...
                  >
                    <g clip-path="url(#clip0_90_164)">
                      <path
                        d="M7.5 1.875L0.46875 5.625L7.5 9.375L14.5312 5.625L7.5 1.875Z"
                        stroke="#AAAAAA"
                        stroke-width="1.3"
                      ...
                      />
                      <path
                        d="M3.28125 7.125V10.3125C3.28125 11.3437 5.15625 12.6562 7.5 12.6562C9.84375 12.6562 11.7188 11.3437 11.7188 10.3125V7.125"
                        stroke="#AAAAAA"
                        stroke-width="1.3"
                        stroke-miterlimit="10"
                        stroke-linecap="round"
            ...
            <div className="  h-[25px] flex items-center  justify-between">
              <div className=" h-full flex items-center gap-1">
                <h3 className=" text-green text-[12px] max-md:text-[10px] font-Yekan font-normal mt-2 dark:text-[#01CEC9] ">
                  تومان
                </h3>
