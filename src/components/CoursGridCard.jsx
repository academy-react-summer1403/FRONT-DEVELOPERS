...
const CoursGridCard = ({title  , cost , teacherName , currentRegistrants , courseId}) => {
  return (
    ...
    >
        <div className='relative rounded-[15px] w-[265px] max-xl:w-[200px] max-sm:w-[190px]  max-md:h-[320px]    max-md:w-[155px] max-sm:h-[310px] h-[305px] dark:hover:bg-gray-600  max-xl:flex flex-wrap justify-center hover:bg-slate-50  bg-white px-4 dark:bg-gray-700/70'
