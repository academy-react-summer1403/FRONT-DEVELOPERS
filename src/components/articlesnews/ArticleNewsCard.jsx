    ...
    >
      <NavLink to={"/article-detail/" + id}>
        <div
          ...
          className="group bg-white/80 dark:bg-gray-600/90 dark:hover:bg-secondary transition duration-500 relative grid-col-1 rounded-t-full shadow px-6
                max-sm:w-[70%] max-sm:mx-auto  max-sm:px-2 h-[400px]  mt-[30px]  min-w-[250px]   
            "
        >
          <img
            src={currentImageAddressTumb ? currentImageAddressTumb : ""}
            onError={ImageErrore}
            className="mx-auto w-[250px] h-[170px] shadow-sm max-sm:w-[70%] rounded-xl"
          />

          <div className="py-4  h-[200px] relative">
            <h3 className="text-lg font-medium text-darkgreen dark:text-white text-right line-clamp-2 ">
              {title}
            </h3>

            <p className="text-xs text-gray-400 dark:text-gray-300 text-right my-4 line-clamp-2 h-[50px] ">
              {miniDescribe}
            </p>
            ...
            <div
              className="flex justify-center pt-2 gap-1 text-xs font-medium w-full
