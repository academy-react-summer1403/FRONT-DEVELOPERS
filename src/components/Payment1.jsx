    ...
    <div>
     ...
     <div  className="w-[100%] h-[100%]   bg-[#fcfaf5cb] overflow-visible  flex mx-auto justify-end flex-wrap">
       <div className=' w-[350px]  px-2 mb-4 text-right font-Yekan flex justify-between'>
          ...
          <div className=' w-[350px]  px-2 mb-4 text-right font-Yekan flex justify-between'>
            <p className='text-[16px] text-gray-600'><DateApi dateapi={item?.peymentDate}/></p>
          ...
          <div className='    w-[350px] flex-nowrap px-2 mb-4 text-right font-Yekan flex justify-between'>
            <p className='text-[16px] text-gray-600 truncate w-[200px] '>{item?.paymentId}</p>
        ...
        <NavLink to={`/paymentall/${item?.paymentId}`} className="w-24 right-4 bottom-8 absolute text-center flex items-center text-gray-500 text-[14px]">
