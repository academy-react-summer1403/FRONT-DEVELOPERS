  ...
  return (
    <div className="container relative max-xl:px-2  mb-28">
      <img
        src={BackLearn}
        alt="2"
        className="absolute w-full  scale-90 h-[70%] right-[0px] bottom-0 opacity-[30%]"
      />
      ...
      <div className=" m-auto relative   ">
        ...
        {/* bg img  */}
        <svg
          className="w-[324px] max-xl:hidden h-[420px] right-4 top-3  absolute "
          width="324"
          height="420"
          viewBox="0 0 324 420"
          fill="none"
          ...
          <defs>
            ...
            >
              ...
              <feComposite
                in2="SourceAlpha"
                operator="in"
                result="effect1_backgroundBlur_102_5167"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_backgroundBlur_102_5167"
                result="shape"
              />
            </filter>
            <linearGradient
              id="paint0_linear_102_5167"
              x1="313.385"
              y1="7.83582"
              x2="-35.7437"
              y2="366.695"
