...
=======
        <div className='container relative border'>
            <img src={BackProducts} alt="" className='absolute left-[200px] top-[-20px] rotate-180 w-[900px] h-[500px] mx-auto opacity-30'/>

            {/* header section  */}
            <div className='flex flex-col relative w-[300px] h-[50px] mx-auto mb-8 border'>
                <div className='w-3 h-3 rounded-full bg-primary mx-auto absolute right-[70px] top-[10px]'></div>
            
                <h1 className='font-bold text-center text-black text-3xl dark:text-white'> خدمات ما </h1>
                <p className=' text-md text-gray-400  text-center mt-5'>مجموعه ای از تمام آنچه شما نیاز دارید</p>
            ...
            '>                
                            ...
                            <div data-aos="zoom-in"  className='
                                ...
                                group w-[220px] h-[180px] mb-[110px] transition-shadow
                            '>
                            ...
                            <div data-aos="zoom-in"  className='
                                ...
                                group w-[220px] h-[180px] mt-[200px] max-sm:-mt-[110px]
                            '>
