...
'>
    ...
    <div className='max-lg:w-[650px] w-[1000px] h-[500px]  mt-[10px]  relative max-sm:w-[550px] '>
        ...
        <img src={Img2} alt="" className='absolute top-[-20px] left-[-10px] max-md:w-[20%] max-lg:w-[20%] max-sm:left-5'/>
        ...
        max-md:w-[150px] max-md:h-[150px] max-md:right-[10px] max-md:top-24 max-sm:right-[5px] max-sm:top-20'/>
        
                <Slider {...settings} className='  absolute w-[700px] h-[250px] py-10  -top-80 max-sm:left-[50px] max-sm:w-[380px] max-sm:h-[180px] max-sm:top-[-220px]  max-md:left-[40px] overflow-hidden left-16  max-md:h-[220px] max-md:w-[460px]  max-md:top-[-255px] max-lg:top-[-250px] max-lg:left-[40px] max-lg:w-[450px] max-lg:h-[210px]       -black rounded-tl-[200px] '>
                    {ImageList.map((data)=>(
                ...
                <div className='     -ml-14'>
                   ...
                   <div className='     flex flex-wrap justify-end'>
                    <h3 className=' text-[#AAAAAA] text-[12px] font-Yekan font-semibold   max-lg:mr-[-80px] max-md:-mr-[300px] max-sm:-mt-1 max-sm:mr-[-90px]  mr-[70px]'>{data.date}</h3>
                    <h1 className='   max-md:-mr-6 text-[26px] text-[#006865] max-sm:text-[18px] max-sm:-mr-6 max-sm:mt-[5px] font-bold font-Yekan max-lg:text-[22px] max-lg:mr-[-45px]  text-right mt-5'>
                        {data.title}
                    </h1>
