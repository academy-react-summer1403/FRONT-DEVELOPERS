    ...
    <>
     ...
     <div className="   mb-[15px]">
      ...
      <div className=' relative '>
            <h4 className=" mark max-xl:text-[20px] max-md:mt-5">توضیحات</h4>
            <div style={{boxShadow:" 0px 1px 2px 0 rgba(0, 0, 0, 0.25)"}} className="bg-white   mt-[15px] rounded-[15px] w-full  p-[36px]    ">
              <div className="overflow-hidden relative ">
                <p 
                  className={` text-[#7B7B7B] text-[19px] text-right font-Yekan font-normal max-xl:text-[17px] max-lg:text-[15px]  leading-[32px] ${
                    showMore ? " h-[570px] " : "h-[]  "
                  }`}
                >
              ...
              <button
                ...
                className="border-[#01CEC9] max-xl:text-[18px]  border-[1px] text-[#006865] hover:scale-105 ease-in-out duration-150 
