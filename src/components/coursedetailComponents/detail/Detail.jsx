  ...
  return (
    <>
      ...
      <div
        ...
        className="bg-white dark:bg-slate-700 max-sm:w-full  max-md:w-[500px] rounded-[15px] w-full h-[1015px] max-md:h-[700px]  p-[23px] max-2xl:p-[15px]"
      >
        ...
        >
          ...
          <div
            ...
            style={{ boxShadow: " 0px 1px 2px 0 rgba(0, 0, 0, 0.25)" }}
            className="w-[174px] max-2xl:w-[45%] h-[71px]  flex justify-center items-center gap-5 dark:bg-slate-800  bg-[#F7F7F7] rounded-[10px]"
          >
            <svg
              width="35"
              height="35"
        ...
        <div className=" w-[367px] h-[860px] mt-[23px] max-sm:w-full  flex flex-wrap gap-[20px] max-md:w-[500px]">
          ...
          <div
            data-aos="zoom-in-right"
            className=" w-full max-2xl:w-[95%]   max-xl:w-[88%] max-sm:w-full  max-lg:w-[75%] max-md:w-[93%] h-[44px]  "
          >
          ...
          <motion.div className="flex flex-wrap w-full gap-5  max-sm:justify-center  max-md:justify-start">
            {loading ? (
              <Related
                cards={6}
                custumStyle="h-[70px] px-4"
                imageStyle=" w-[60px] h-[40px] mt-2"
              />
            ) : (
          ...
          <div
            data-aos="zoom-in-right"
            className="max-sm:mx-auto  w-[177px] h-[200px] max-lg:mr-[130px] max-md:mt-[-260px] max-md:mr-[160px]  mx-auto max-xl:pr-[30px]"
          >
            <img
