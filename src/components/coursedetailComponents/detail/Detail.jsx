          ...
          <div style={{boxShadow:" 0px 1px 2px 0 rgba(0, 0, 0, 0.25)"}} className="bg-white rounded-[15px] w-[412px] h-[1015px]  p-[23px]">
            ...
            <div className=" w-[366px] h-[71px]  flex justify-between">
              ...
              <div style={{boxShadow:" 0px 1px 2px 0 rgba(0, 0, 0, 0.25)"}} className="w-[174px]  h-[71px]  flex justify-center items-center gap-5 bg-[#F7F7F7] rounded-[10px]">
                ...
                <h4 className=" font-Yekan font-normal text-[19px] leading-[21px] text-center  w-[40px] text-[#444444] h-[43px]">
                  {" "}
                  4.7 <h4 className="text-[#888888]">رضایت</h4>
                </h4>
              </div>
              ...
              <div style={{boxShadow:" 0px 1px 2px 0 rgba(0, 0, 0, 0.25)"}} className="w-[174px]  h-[71px] flex justify-center items-center gap-5  bg-[#F7F7F7] rounded-[10px] ">
                ...
                <h4 className=" font-Yekan font-normal text-[19px] leading-[21px] text-[#444444] text-center  w-[40px] h-[43px]">
                  {" "}
                  216 <h4 className="text-[#888888]">دانشجو</h4>
                </h4>{" "}
              </div>
            </div>
            ...
            <div className=" w-[367px] h-[860px] mt-[23px] flex flex-wrap gap-[20px]">
              ...
              <div className=" w-full h-[44px]  ">
                <div className="flex justify-between">
                  ...
                  <h3 className="font-Yekan font-normal text-[16px] text-[#00504E] text-right  ">
                    درصد تکمیل دوره
                  </h3>
                </div>

                <div className=" h-[8px] rounded-full bg-[#F0F0F0] mt-2">
                  <div
                    className="h-[8px] rounded-full bg-[#01CEC9] "
                    style={{ width: "87%" }}
                  >
                    {" "}
                  </div>
