            ...
            {accordions.map((data, index) => (
              <div
                ...
                className={`  flex cursor-pointer items-center flex-wrap   rounded-t-[10px]  rounded-b-[10px]  w-[809px] ${
                  data.isOpen
                    ? "bg-[#00E2DC] dark:bg-slate-300"
                    : "dark:bg-slate-700 bg-[#FFFFFF] h-[51px]"
                }`}
              >
                <div
                      ...
                      {loading ? (
                        ...
                        <div
                          className={` text-right justify-self-start font-normal font-Yekan text-[17px] h-[32px] gap-1 items-center flex ${
                            data.isOpen
                              ? "text-[#005B58]  dark:text-slate-600"
                              : "text-[#888888] dark:text-slate-200"
                          } `}
                        >
                          ساعت
                          <h3 className="max-lg:text-[13px]  ">{data.time}</h3>
                          .جلسه
                          <h3 className=" max-lg:text-[13px]   ">
                            {data.setion}
                          </h3>
                        </div>
                      )}
                  ...
                  {loading ? (
                    ...
                    <h2
                      className={` text-[#555555] text-right  max-lg:text-[13px] max-lg:line-clamp-1 max-xl:text-[16px]  font-normal font-Yekan text-[20px] h-[32px] ${
                        data.isOpen
                          ? "text-[#006865]"
                          : "text-[#555555] dark:text-slate-300"
                      } `}
                    >
                      {data.title}
                    </h2>
                    ...
                    {data.items.map((item, itemIndex) => (
                      <div key={itemIndex}>
                        <div
                          ...
                          onClick={() => togglePlay(data.key, itemIndex)}
                        >
                          ...
                          <h3 className="text-[#006865] dark:text-blue-950 text-[16px]">
                            {item.data}
                          </h3>
                        </div>
