...
const Commentdiv = ({comentdiv,setCommentdiv,holder,Id}) => {
  ...
  return (
    ...
    <div className={`${comentdiv ? "block" : "hidden"} border border-gray-300  dark:bg-slate-600 bg-[#e2e2e2ee] w-[550px] max-lg:w-3/4 h-[200px] rounded-3xl z-50 top-[35%]  fixed `}>
   ...
   <path d="M1.72313 1.72267L10.562 10.5615M10.562 1.72267L1.72313 10.5615" stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <form 
               ...
               >
                 <div className=" w-[500px]  max-lg:w-3/4  m-auto mt-6 h-[50px] ">
