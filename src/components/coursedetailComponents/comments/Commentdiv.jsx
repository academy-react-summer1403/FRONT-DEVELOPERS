...
//     <svg onClick={()=>setCommentdiv(false)} className="  dark:border-white stroke-black dark:stroke-white   mt-5 ml-[92%]" width="15" height="15" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//                >
//                  <div className=" w-[500px]  max-xl:w-3/4  m-auto mt-6 h-[50px] ">
...
//                    </div>
//                    <button type="submit" className="bg-primary dark:bg-secondary font-Yekan text-darkgreen dark:text-white rounded-[30px] ml-[67%] max-xl:mx-auto max-xl:grid max-lg:leading-8 w-[150px] h-[35px] mt-7 ">افزودن نظر جدید</button>
//                </form>
