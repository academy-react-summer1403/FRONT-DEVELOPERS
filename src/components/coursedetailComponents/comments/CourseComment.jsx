...
import { useDeleteCourseCommentLike, useDeleteLikeComment, useDislikeCourseComment, useLikeCommentCourse, usePostCommentCourse, usePostReplyComment } from '../../../core/services/mutation/DetailsMutation';
                ...
                <div className='w-full h-full flex flex-col'>
                    ...
                    <div className=' border-b justify-between h-[80px] px-5 flex items-center'>
                        ...
                        <div className='  gap-3 flex items-center justify-between'>
                            ...
                            <AddReplyCourse comentdiv={replydiv} setCommentdiv={setReplydiv}  Id={courseId} commentId={item.id} /> 
                    ...
                    <div className='w-full  flex justify-start'>
                        <ReplyCourse courseId={courseId} courseCommmentId={item?.id} showMore={showMore}/> 
                    </div>  
                </div>          
            </div>
