...
const ReplyCourse = ({id , useId,showMore,setCommentdiv1,comentdiv1 , parentId}) => {
   ...
   const Reply = useReplyCourse(id , useId , parentId)
...
<svg className=' stroke-orange/80' width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
