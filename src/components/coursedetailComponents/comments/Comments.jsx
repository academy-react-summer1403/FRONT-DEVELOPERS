...
import { postLike } from "../../../core/services/apiComment";

// import { useLikeComment } from "../../../core/services/query/mutaion/mutation";
...
const CommentLike=postLike( token ,params  )
                    ...
                    <div className="h-[60px] w-full  flex justify-between flex-row-reverse">
                      ...
                      <div className="  flex  flex-row-reverse gap-3">
                        ...
                        {data?.likeCount}
                          ...
                          <button onClick={()=>setLike(data?.id)}>
                              <svg 
                              width="20"
                              height="19"
                                className= "max-lg:w-[15px] max-lg:h-[17px]"
