...
import { useLikeComment } from "../../../core/services/mutation/DetailsMutation";
...
const ReplyArticle = ({ showMore, Id, UserId }) => {
  ...
  return (
    <div
      className={` w-full  ${showMore ? "h-[150px] overflow-hidden" : "h-[]"}`}
    >
      {loading ? (
        <CommentsLoading />
      ) : (
        getReply.data?.map((item) => (
          <div
            style={{ boxShadow: "0px 1px 1px 0px rgba(0 ,0,0,0.2) inset" }}
            ...
            <div className=" border-b border-gray-300 w-full justify-between h-[80px] flex items-center">
              <div className="  gap-3 flex items-center justify-between">
                ...
                <h3 onClick={() => ""} className="like flex items-center gap-2">
                  <svg
                    ...
                    className={`cursor-pointer max-lg:w-[15px] max-lg:h-[17px] stroke-orange/80
                                    ${
                                      item?.currentUserIsDissLike == true
                                        ? "fill-orange/80 "
                                        : " "
                                    } `}
                    viewBox="0 0 20 19"
              ...
              <div className="  flex items-center">
                <div className="text-right">
                  ...
                  <h4 className=" datecomment  max-sm:mt-4">
                    {" "}
                    <DateApi dateapi={item?.inserDate} />
                  </h4>
                </div>
