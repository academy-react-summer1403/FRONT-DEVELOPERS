...
const NewComment = ({id , UserId }) => {
  ...
  const [loading, setLoading] = useState(true)
    ...
    console.log(GetCommentNews.data)
                    ...
                    <div className=' border-b justify-between h-[80px] px-5 flex items-center'>
                        ...
                        <div className='  gap-3 flex items-center justify-between'>
                            ...
                            <h3 className=' like flex items-center gap-2'>
                                <svg  onClick={()=>{item?.currentUserIsLike == true  ? handledeleteComment(item?.currentUserLikeId)  : handleLikeComment(item?.id)}} width="20" height="19" className={`cursor-pointer max-lg:w-[15px] max-lg:h-[17px] stroke-orange/80
