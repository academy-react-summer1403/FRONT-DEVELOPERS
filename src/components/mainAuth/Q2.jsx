                ...
                <div className="relative flex flex-col gap-2">
                  <div
                    ...
                    className={`flex w-[200px]  ${
                      l == 2 ? "ml-56  items-center" : " items-end"
                    }`}
                  >
                    {" "}
                    <img src={first} className=" h-[20px] pr-2  " alt="" />
                    <h1
                      className=" text-right   
                    text-[12px] font-semibold text-[#a11a1a]  "
                    >
                      {t("green")}
                    </h1>
                  </div>
                  ...
                  <div
                    ...
                    className={`flex w-[200px] ${
                      l == 2 ? "ml-[225px] items-center" : " items-end"
                    } `}
                  >
                    {" "}
                    <img src={second} className=" h-[20px] pr-3  " alt="" />
                    <h1
                      className=" text-right   
                    text-[12px] font-semibold text-[#a11a1a]  "
                    >
                  ...
                  <hr />
                  <div
                    onClick={() => handleThemeChange("thirdTheme")}
                    className={`flex w-[200px] ${
                      l == 2 ? "ml-[225px] items-center" : "  items-end"
                    }`}
                  >
                    ...
                    <img
                      src={third}
                      className={`h-[20px]  ${l == 2 ? "pr-6" : "pr-3"} `}
                      alt=""
                    />
                    <h1
                      className=" text-right   
                  ...
                  >
                    {" "}
                    <img src={light} className=" h-[20px] pr-1  " alt="" />
                    <h1
                      className=" text-right   
                    text-[10px] font-semibold text-[#a11a1a]  "
                    >
                      {t("night")}
                    </h1>
                  </div>
                  ...
                  <NavLink to={"/auth/s1"}>
                    <button className="w-[90px] h-[30px] rounded-2xl  absolute top-[170px] left-[-10px] text-green text-[10px] font-semibold">
                      {" "}
                      {t("last")}
                    </button>
                  </NavLink>
