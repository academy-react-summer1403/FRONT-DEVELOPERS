    ...
    <div className="flex justify-center items-center relative">
     ...
     rounded-2xl 
      ...
      leading-[50px] -bottom-[10px] left-[20px]"
        ...
        <div className="w-full h-full border border-[#fff0] relative"><img
          ...
          >
            ...
            <div className="absolute w-[300px] h-[200px] left-[25px] top-[120px] ">
             ...
             <div>  <label className='  mt-3 text-[14px]  font-medium  flex flex-row-reverse gap-2'>
        <input
          type="radio"
          name="option"
          value="فرانت"
        ...
        />
          فرانت اند
        </label> <hr className=' mt-2 w-20' /></div> 

       
        <div>  <label className='  flex text-[14px]  font-medium flex-row-reverse gap-2'>
        <input
          type="radio"
          name="option"
          value="بک"
      ...
      <div>  <label className='  text-[14px]  font-medium flex flex-row-reverse gap-2'>
        <input
          type="radio"
          name="option"
          value="فول"
