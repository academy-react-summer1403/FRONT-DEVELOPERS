  ...
  return (
    <>
      ...
      <div
        ...
        className="p-4 rounded-xl bg-primary/60 w-20 cursor-pointer"
      >
        open
      </div>
          ...
          >
            <div className="relative flex flex-col gap-4">
              ...
              <i
                ...
                className="absolute right-16 bottom-[130px]"
              >
                {showHidePassword ? (
              ...
              <h1
                className="w-[60px] h-[10px]   ml-[55px]  text-[8px] font-semibold text-orange
