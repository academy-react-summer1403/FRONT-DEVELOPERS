  ...
  return (
    <div className='container h-[80px]  flex items-center '>
        <div className='flex justify-start flex-row gap-3 items-center  w-[400px] h-[60px]'>
                ...
                <div className='w-[8%] h-[50%] bg-green rounded-full dark:bg-orange'><img src={Telegram} alt="" className='ml-[4px] mt-[3px]'/></div>
                <div className='w-[8%] h-[50%] bg-green rounded-full dark:bg-orange'><img src={instagram} alt="" className='ml-[4px] mt-[3px]'/></div>
