      ...
      >
        ...
        <div className="  flex items-center justify-between ">
          <svg
            width="116"
            height="23"
            className="max-xl:h-[20px] flex flex-row-reverse"
            viewBox="0 0 116 23"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              ...
              className={`peer stroke-[#FFC700] hover:fill-[#FFC700] ${
                colorRate == 5 ? "fill-[#FFC700]" : "fill-white"
              }`}
              fill-rule="evenodd"
              clip-rule="evenodd"
            ...
            <path
              ...
              className={`peer stroke-[#FFC700] hover:fill-[#FFC700] peer-hover:fill-[#FFC700]
                ${
                  colorRate === 3 || colorRate === 4 || colorRate === 5
                    ? "fill-[#FFC700]"
                    : "fill-white"
                }`}
              fill-rule="evenodd"
