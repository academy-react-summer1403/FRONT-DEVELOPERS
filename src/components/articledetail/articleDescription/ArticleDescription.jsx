...
const ArticleDescription = () => {
  ...
  return (
    <div className=" max-xl:w-[600px] max-lg:w-[450px] max-md:w-full">
      <div
        style={{ boxShadow: " 0px 1px 2px 0 #00000040" }}
        className=" bg-white   p-[24.5px]  mt-[15px] rounded-[15px]   "
      >
        <div
          className={` overflow-hidden   ${showMore ? "h-[1586px] max-lg:h-[800px] max-xl:h-[995px]" : "h-[] transition delay-150 duration-300"}`}
        >
          <p 
            className={`bg-white text-right  font-Yekan font-normal text-[18px] max-lg:text-[14px] max-xl:text-[16px] text-[#555555] leading-[30px]   ${
              showMore ? "h-[1586px] max-xl:h-[995px] max-lg:h-[1200px]" : "h-[]"
            }`}
          >
            ری اکت چیست؟ تصور کنید یک مهندس طراحی خودرو نخبه ، قصد داره یک ماشین
            جدید و جذاب بسازه. این مهندس ما دو راه برای رسیدن به هدفش داره! ما
            در این مقاله قراره خیلی خودمونی بگیم ری اکت چی هستش ؟ که در کنارش
            بتونید از آموزش react لذت ببرید . خب پس بزن بریم ! 1 – مثلا به دولت
            مراجعه کنه و بگه لطفا ابزار و مواد اولیه لازم رو در اختیار من قرار
            بدید تا این ماشین رو بسازم. فردا می بینه یک کامیون پر از آهن و
            پلاستیک و … به صورت خام در کارگاهش تخلیه شده و اون باید تمام چندهزار
            قطعه ماشین رو از صفر طراحی و تولید کنه. 2 – یا اینکه طرح قطعات و
            قالب های طراحی شده خودش رو به یک شرکت دانش بنیان و قطعه ساز ارائه
            بده که خودش متخصص این کار هست و قبلا هزاران نوع قطعه آماده تولید
            کرده. در این صورت مهندس ما هم خیلی راحت تمام قطعات موردنیاز خودش رو
            تحویل می‌گیره تا ماشین جدید خودش رو بسازه. چیزی شبیه به تولید ماشینی
            مثل لامبورگینی! این ساده ترین جواب مقدماتی برای درک جواب سوال ری اکت
            چیست؟ می تونه باشه!
            <img
              className="w-[575px] h-[320px] max-lg:w-[500px] max-lg:h-[250px] max-xl:w-[535px] max-xl:h-[280px] rounded-[10px] mx-auto my-[20px]"
              src="https://s3-alpha-sig.figma.com/img/b34a/f91c/909626fcb0578636953084bea527bc56?Expires=1728864000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=pX8f4RHaOYWR9rrh0pFIxmSxUmv8XSUIaw0HFt8k~W0sdrIQF85toO8~4V8b5TlvIKYjTzpFEVR1hYcA8V5B5GovB2EseEdFOm4qxvnu0bfLyKrNkCTjCqeedTisnVSsioXdccp4FGk5E21806qTpV9DFKGlHQjfobJvMG7ynQsliZJNBlwrThRu8ZbgdJDGy4GIIjo~HCvVPkGbaWSxtL73E4vxjaXw91GXiK0aTiIOatezpiZPBgViMlir23q5~t17AXbp1FT1W0EsmWn8pfdqJarrUrmbnu1HNi8JngYQoZVJlYuuQ0MuAM-HFDFOLTA~U1wkLmRwq-3N5AZOLQ__"
              alt=""
            />
            ری اکت (React) مثل همون شرکت دانش بنیانی هست که دستیار شما میشه تا
            راحت تر چیزی که در ذهنتون هست رو در رابط کاربری سایت (UI) پیاده سازی
            کنید بدون اینکه بخواید از صفر کدنویسی انجام بدید. بعد هم با ایجاد
            بخش های مختلف و متصل کردن اونها به همدیگه، صفحات وب جذاب و کامل
            بسازید. حالا اگه دوست دارید پاسخ سوال React چیست؟ رو به زبان ساده و
            خودمونی بگیرید و همینطور کاربرد ری اکت و مزایای اون و اینکه چطور
            باید یاد گرفت، ما در ادامه مقاله ، قدم به قدم با شما جلو میریم تا
            خیلی خوب و عمیق با تمام ابعاد اون آشنا بشید و از این تخصص پولساز و
            پرطرفدار لذت ببرید. “” طبق روال همیشگی قبل از هر چیز یک نکته رو
            یادآوری کنیم که در سبزلرن، نوشتن بعضی از محتواهای محتوای آموزشی با
            فرض بر مبتدی بودن کاربر انجام میشه تا مطمئن بشیم همه شما می تونید از
            اونها استفاده کنید اما اگر کاربر حرفه ای هستید و با اصول و تعاریف هر
            موضوع آشنایی کامل دارید، می تونید از بخش‌های اولیه محتوا بگذرید و یه
            راست وارد بخش های بعدی بشید. “” حالا ببینیم در ادامه این مقاله قراره
            از کجا به کجا برسیم ؟! یا ری اکت چیست؟ و چگونه کار می کند؟ ویژگی ها
            و مزایای ری اکت چیست؟ پیش نیازها و ابزارهای مورد نیاز برای یادگیری
            ری اکت مسیر حرفه ای تر شدن در طراحی رابط کاربری با ری اکت بازار کار
            برنامه نویسی فرانت اند با ری اکت پس طبق معمول با تمرکز بالا همراه
            سبزلرن باشید تا خیلی خوب و عمیق، ری اکت رو بشناسید و یاد بگیرید. ری
            اکت یا React چیست؟ و چگونه کار می کند؟ اول ببینیم که حرف حساب کتاب
            ها و داکیومنت ها برای تعریف اون چیه؟! ” ری اکت یا React  یک کتابخانه
            جاوا اسکریپتی متن باز (Open Source) برای ساخت و توسعه رابط کاربری
            (UI) است که در سال 2011 توسط Facebook تولید و طی دو سال بعد توسعه و
            در اختیار عموم قرار گرفت. این تکنولوژی با استفاده از مفهوم کامپیوننت
            (component) به عنوان جزء و شیء با قابلیت استفاده مجدد، امکان طراحی
            صفحات پویا با واکنش سریع را فراهم کرده است.” طبیعتا اگر از قبل با
            مفاهیم برنامه نویسی و به طور ویژه جاوا اسکریپت آشنا بودید که احتمالا
            خیلی راحت و واضح این تعریف رو متوجه شدید اما اگر تازه کار هستید و
            هنوز شناخت کاملی از اصطلاحات برنامه نویسی ندارید ممکنه خود جواب این
            سوال هم چندتا سوال دیگه در ذهن شما به وجود بیاره برای همین چندتا
            تعریف کوتاه دیگه رو در تکمیل اون به شما می‌گیم تا اگر مبتدی و تازه
            کار هم باشید خیلی راحت و مفهومی درکش کنید. یکبار برای همیشه!  ه کجا
            برسیم ؟! یا ری اکت چیست؟ و چگونه کار می کند؟ ویژگی ها و مزایای ری
            اکت چیست؟ پیش نیازها و ابزارهای مورد نیاز برای یادگیری ری اکت مسیر
            حرفه ای تر شدن در طراحی رابط کاربری با ری اکت بازار کار برنامه نویسی
            فرانت اند با ری اکت پس طبق معمول با تمرکز بالا همراه سبزلرن باشید تا
            خیلی خوب و عمیق، ری اکت رو بشناسید و یاد بگیرید. ری اکت یا React
            چیست؟ و چگونه کار می کند؟ اول ببینیم که حرف حساب کتاب ها و داکیومنت
            ها برای تعریف اون چیه؟! ” ری اکت یا React  یک کتابخانه جاوا اسکریپتی
            متن باز (Open Source) برای ساخت و توسعه رابط کاربری (UI) است که در
            سال 2011 توسط Facebook تولید و طی دو سال بعد توسعه و در اختیار عموم
            قرار گرفت. این تکنولوژی با استفاده از مفهوم کامپیوننت (component) به
            عنوان جزء و شیء با قابلیت استفاده مجدد، امکان طراحی صفحات پویا با
            واکنش سریع را فراهم کرده است.” طبیعتا اگر از قبل با مفاهیم برنامه
            نویسی و به طور ویژه جاوا اسکریپت آشنا بودید که احتمالا خیلی راحت و
            واضح این تعریف رو متوجه شدید اما اگر تازه کار هستید و هنوز شناخت
            کاملی از اصطلاحات برنامه نویسی ندارید ممکنه خود جواب این سوال هم
            چندتا سوال دیگه در ذهن شما به وجود بیاره برای همین چندتا تعریف کوتاه
            دیگه رو در تکمیل اون به شما می‌گیم تا اگر مبتدی و تازه کار هم باشید
            خیلی راحت و مفهومی درکش کنید. یکبار برای همیشه!  یا ری اکت چیست؟ و
            چگونه کار می کند؟ ویژگی ها و مزایای ری اکت چیست؟ پیش نیازها و
            ابزارهای مورد نیاز برای یادگیری ری اکت مسیر حرفه ای تر شدن در طراحی
            رابط کاربری با ری اکت بازار کار برنامه نویسی فرانت اند با ری اکت پس
            ...
            Facebook تولید و طی دو سال بعد توسعه و در اختیار عموم قرار گرفت. این
            تکنولوژی با استفاده از مفهوم کامپیوننت (component) به عنوان جزء و
            شیء با قابلیت استفاده مجدد، امکان طراحی صفحات پویا با واکنش سریع را
            فراهم کرده است.” طبیعتا اگر از قبل با مفاهیم برنامه نویسی و به طور
            ویژه جاوا اسکریپت آشنا بودید که احتمالا خیلی راحت و واضح این تعریف
            رو متوجه شدید اما اگر تازه کار هستید و هنوز شناخت کاملی از اصطلاحات
            برنامه نویسی ندارید ممکنه خود جواب این سوال هم چندتا سوال دیگه در
        ...
        <button
          ...
          className="border-[#01CEC9] border-[1px] text-[#006865] hover:scale-105 ease-in-out duration-150  
leading-[32px] font-normal font-Yekan text-[20px] max-xl:text-[18px] flex items-center w-[174px] max-xl:w-[150px] max-xl:h-[40px] h-[45px] rounded-[45px] mx-auto justify-center gap-2 mt-3  "
        >
          {showMore ? (
            <svg
              width="14"
              height="8"
              className=" max-xl:w-[13px] max-xl:h-[7px]"
              viewBox="0 0 14 8"
              fill="none"
      ...
      <div
        style={{ boxShadow: " 0px 1px 2px 0 #00000040" }}
        className=" my-[20px] px-[24.5px]  w-full h-[52px] rounded-[8px] bg-white flex justify-between items-center"
      >
        <div className=" flex items-center gap-5">
          <div className="  share max-xl:text-[14px] flex items-center gap-2">
            <svg
              width="20"
              height="19"
                className="max-xl:h-[15px] max-xl:w-[16px]"
              viewBox="0 0 20 19"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <div className="  flex items-center gap-2">
            <h3 className="share max-xl:text-[14px]">اشتراک گزاری</h3>
            <svg
              width="19"
              height="19"

              className="max-xl:h-[15px] max-xl:w-[15px]"
              viewBox="0 0 19 19"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <div className="  flex items-center justify-between">
          ...
          <h1 className=" share max-xl:text-[14px] ">
            امتیاز ۳۵ نفر
          </h1>
        </div>
      </div>
