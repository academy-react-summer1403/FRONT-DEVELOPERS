  ...
  return (
    ...
    <div className=' ml-10  px-3 py-5 rounded-[30px] h-[150px] w-[50%]'>
        ...
        <div className=' items-center px-1 flex max-sm:gap-3 justify-between '> 
            ...
            <h3 className='text-[#333333] text-[18px] font-semibold  line-clamp-1 flex justify-end max-xl:w-36  max-2xl:w-60 max-md:w-24 text-nowrap max-md:text-[13px]'>نام دوره موردنظر </h3>
        </div>
        ...
        <div className=' mt-12  items-center px-1 max-xl:gap-2 flex justify-between '>
            ...
            <h3  className='max-xl:text-[12px]  line-clamp-1 text-nowrap  object-cover justify-end flex gap-1 items-center text-[15.5px] w-40 font-medium text-[#757575]'>  دوره موردنظر 
