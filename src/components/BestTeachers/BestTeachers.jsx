  ...
  return (
    <div className='flex-1 h-[402px]  w-full'>
      ...
      <div className=' flex h-[495px] max-lg:bg-primary/30 max-md:h-[600px] max-sm:my-12    mx-auto  relative justify-center'>
            <svg className=' w-full max-lg:hidden  h-full mx-auto ' height="402" viewBox="0 0 1440 402" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='flex  justify-between items-center w-full   absolute top-10'>
          <div className='relative mx-auto w-[1500px] h-[400px]  grid grid-cols-2 justify-between
           max-xl:w-[full]  
           max-md:grid-cols-1
          '>      
