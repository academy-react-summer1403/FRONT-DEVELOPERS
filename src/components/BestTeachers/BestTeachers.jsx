...
const BestTeachers = () => {
  ...
  return (
    <div className='flex-1 h-[402px]  w-full'>
        ...
        <div className='mx-auto h-[402px] relative  max-xl:flex justify-center h-[495px] max-sm:bg-primary/20 max-sm:h-[395px] max-sm:my-12'>
            <svg className=' w-full  h-full mx-auto max-sm:hidden' height="402" viewBox="0 0 1440 402" fill="none" xmlns="http://www.w3.org/2000/svg">
