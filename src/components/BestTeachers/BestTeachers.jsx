    ...
    <div className='flex-1 h-[500px]  '>
        ...
        <div className='flex-1 justify-center items-center w-full absolute top-10'>
            ...
            {/* Tinder card  */}
                        ...
                        <div className=' w-[400px] h-[400px]  absolute left-[200px] bottom-[50px]'>
          ...
          md:pr-16 xl:pr-40 md:py-0 absolute top-[140px] right-[100px]"
          >
            ...
            <motion.h1
             ...
             animate="visible"
              ...
              !leading-tight
              text-right absolute -top-[30px] right-[70px]"
            >
              برترین اساتید  
            ...
            initial="hidden"
            animate="visible"
            className=' font-sans text-[40px] text-primary absolute -top-[20px] left-[5px] '>رو همینجا پیدا کنید</motion.span>

            <motion.p
               variants={SliderRight(0.6)}
               initial="hidden"
               animate="visible"
               className=' text-center indent-[130px] font-sans text-gray-600 pt-[50px] leading-[10px]'
            >
