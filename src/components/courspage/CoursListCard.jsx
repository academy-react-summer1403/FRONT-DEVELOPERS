...
const CoursListCard = () => {
  return (
    <div className='grid grid-cols-2 gap-4 mt-8 p-2
    max-sm:grid-cols-1
    max-md:grid-cols-1
    max-lg:grid-cols-1
    
    '>
        <div className='relative flex flex-row-reverse rounded-xl p-3 w-full gap-[2%] max-md:gap-[9%] max-lg:gap-[10%] '
        ...
        >   
            ...
            <div 
                ...
                className='relative grid justify-items-center py-8 right-0 w-[45%] 
