...
const CoursGridCard = ({title , levelName , cost , teacherName , likeCount , courseId , tumbImageAddress}) => {
  ...
  return (
    // container 
  <motion.div className='grid grid-col-1 h-[320px] mt-20 max-sm:min-w-[310px] mx-[10px] max-md:mx-0'
        ...
        <NavLink to={"/courses-detail/" + courseId}>
            {/* map part of card:  */}
                ...
                >   
                    ...
                    >
                        <img src={tumbImageAddress ? tumbImageAddress : ImageErrore} onError={ImageErrore}   className='rounded-xl w-full h-full'/>                  
