    ...
    <>
      <div className="z-40 relative flex flex-col gap-2  ">
        <div className="flex flex-row justify-end overflow-hidden">
          <label className="cursor-pointer" htmlFor="teacher1" to="checkbox">
            {teacher.data?.[0].fullName}
          </label>
          <input
            id="teacher1"
            type="checkbox"
            ...
            onClick={
              filter
                ? () =>
                    dispatch(Add(teacher.data?.[0].teacherId), setFilter(false))
        ...
        <div className=" flex flex-row justify-end overflow-hidden ">
          ...
          <input
            ...
            onClick={
              filter3
                ? () =>
                    dispatch(Add(teacher.data?.[2].teacherId), setFilter(false))
        ...
        <div className=" flex flex-row justify-end overflow-hidden ">
          ...
          <input
            ...
            onClick={
              filter4
                ? () =>
                    dispatch(Add(teacher.data?.[3].teacherId), setFilter(false))
