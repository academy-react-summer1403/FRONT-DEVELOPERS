    ...
    <>
      <div className="z-40 relative flex flex-col gap-2">
        <div className="flex flex-row justify-end">
          <label htmlFor="setFilter" to="checkbox" className="cursor-pointer">
            {category.data?.[0].techName}
          </label>
          <input
            id="setFilter"
            type="checkbox"
            ...
            onClick={
              filter
                ? () => dispatch(Add(category.data?.[0].id), setFilter(false))
                : () => dispatch(Add(""), setFilter(true))
            }
          />
        </div>
        <div className="flex flex-row justify-end ">
          <label htmlFor="setFilter2" to="checkbox" className="cursor-pointer">
            {category.data?.[1].techName}
          </label>
          <input
            id="setFilter2"
            type="checkbox"
            ...
            onClick={
              filter2
                ? () => dispatch(Add(category.data?.[1].id), setFilter2(false))
                : () => dispatch(Add(""), setFilter2(true))
            }
          />
        </div>
        <div className=" flex flex-row justify-end ">
          <label htmlFor="setFilter3" to="checkbox" className="cursor-pointer">
            {category.data?.[2].techName}
          </label>
          <input
            id="setFilter3"
            type="checkbox"
            ...
            onClick={
              filter3
                ? () => dispatch(Add(category.data?.[2].id), setFilter3(false))
                : () => dispatch(Add(""), setFilter3(true))
            }
          />
        </div>
        <div className="flex flex-row justify-end">
          <label htmlFor="setFilter4" to="checkbox" className="cursor-pointer">
            {category.data?.[3].techName}
          </label>
          <input
            id="setFilter4"
            type="checkbox"
            ...
            onClick={
              filter4
                ? () => dispatch(Add(category.data?.[3].id), setFilter4(false))
