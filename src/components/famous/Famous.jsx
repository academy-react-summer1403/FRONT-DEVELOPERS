...
const Famous = () => {
  ...
  return (
    <div className="flex-1 h-[500px]  mt-12 relative   w-full">
      <h1 className="  head1 max-sm:text-center">
        {t("category")}
      ...
      <div className="flex h-[495px] max-sm:bg-primary/20 max-sm:h-[395px] max-sm:my-12 ">
        ...
        >
          <g filter="url(#filter0_b_109_478)">
            <path
              ...
              className=" w-full  h-full mx-auto fill-primary"
              fill-opacity="0.3"
            />
          </g>
          <defs>
            <filter
              id="filter0_b_109_478"
              x="-522.5"
              y="-6"
              width="9496"
              height="508"
            ...
            >
              ...
              <feComposite
                in2="SourceAlpha"
                operator="in"
                result="effect1_backgroundBlur_109_478"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_backgroundBlur_109_478"
                result="shape"
              />
            </filter>
          </defs>
        ...
        >
          <div
            style={{ boxShadow: " 3px 3px 8px 0px #00000080 inset" }}
            className="  famous"
          >
            <h1 className="famoustext ">{t("Network")}</h1>
            <img src={SecurityImg} alt="" className="famousimg" />
          </div>
          ...
          >
            ...
            <img src={GameImg} alt="" className="famousimg" />
          </div>
          ...
          >
            ...
            <img src={BarImg} alt="" className="famousimg " />
          </div>
          ...
          >
            ...
            <img src={PCImg} alt="" className="famousimg " />
          </div>
        </div>
      </div>
    </div>
