  ...
  return (
    <div className="container">
      <img
        src={BackImg}
        alt=""
        className="absolute w-[690px] left-[290px] max-md:left-0 max-sm:left-0 z-0"
      />
      ...
      <motion.div
        ...
        className="flex flex-row rounded-tl-lg rounded-tr-[90px] rounded-br-lg rounded-bl-[80px] my-10 px-4 shadow dark:bg-gray-700/70 bg-primary/5 max-md:flex-col max-sm:flex-col max-lg:flex-col max-xl:flex-row"
      >
        {/* hero vector */}
        <div className="w-[500px] max-lg:hidden relative">
          <img
            src={Herobg}
            alt=""
            className="absolute w-[390px] left-[115px] top-[-30px]"
          />
      ...
      {/* body  */}
      <div className="my-28 grid grid-cols-4 gap-4 max-sm:flex flex-col-reverse max-md:flex max-lg:flex">
        {/*right: offer section  */}
        <OfferSection />
        ...
        <div className="relative col-span-3 ">
          {/* top part */}
          <div className="relative flex flex-row-reverse max-sm:flex-col">
            ...
            <div className="relative group max-sm:grid max-sm:justify-items-center">
              <div className="group flex px-5 py-2 mr-4 gap-6 dark:bg-gray-700/70 rounded-full shadow-sm shadow-gray-300 outline-none indent-0 dark:text-white text-gray-900 hover:bg-gray-50 cursor-pointer text-lg">
                <IoIosArrowDown
                  className="relative mt-2 h-5 w-5 flex-none text-teal-900 dark:text-teal-600 rotate-180 group-hover:rotate-0 duration-300"
                />
                {t("newest")}
                  ...
                  {categories.map((item, index) => (
                    <li key={index} className="group">
                      <div
                        ...
                        className="inline-block px-4 font-semibold text-gray-500 hover:text-black dark:hover:text-white duration-200 p-2 w-full hover:bg-teal-100 rounded-md text-right group-data-[selected]:font-semibold cursor-pointer"
                      >
                        {item}
                      </div>
                    </li>
          ...
          {/* card  */}
          <div className="grid grid-cols-3 my-8 gap-4 max-sm:grid-cols-1 max-md:grid-cols-2 max-lg:grid-cols-2">
