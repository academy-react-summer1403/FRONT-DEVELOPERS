...
const StdInformation = () => {
  ...
  return (
    ...
    >
      <img
        src={
          userProfile.data?.currentPictureAddress ? (
            userProfile.data?.currentPictureAddress
          ) : (
            <ImageErrore />
          )
        ...
        onError={ImageErrore}
        className="absolute right-10 top-[-50px] w-[80px] h-[80px] rounded-full"
      />
