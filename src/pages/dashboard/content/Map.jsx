...
const Map = () => {
  ...
  return (
    <section className='flex flex-col gap-4 bg-white w-[740px] h-[470px] z-[5000] border shadow-lg rounded-[10px]'>
      ...
      <section className='w-[740px] h-[400px]'>
    ...
    {markerPosition && (
      ...
      <button onClick={handleNewUserPosition} className=' py-2 bg-green text-white flex-1'>تایید موقعیت کاربری</button>
