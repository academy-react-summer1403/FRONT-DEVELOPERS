  ...
  return (
    <div className='py-10 '>
      ...
      <div className='relative gap-32 grid grid-cols-2 mb-12 justify-items-center '>
        ...
        <h3 className='absolute place-self-center bottom-[-8px] text-lg text-gray-400'>تنظیمات امنیتی</h3>     
        <img className='absolute right-14 bottom-[-16px] max-sm:right-2 rounded-lg' src={secure}/>
        <hr className='border grid-col-1 border-gray-100 w-full'/>
      ...
      <Accordion className='grid grid-cols-1 mx-auto border'>
         ...
         <AccordionItem className='my-4' header={
            <div className='group relative grid-col-1 grid grid-cols-1 mx-8 pl-4 
              w-[780px] 
              max-xl:w-[500px]
              max-lg:w-[550px]
              max-md:w-[450px]
            '>
               ...
               <hr className='border border-gray-100 w-[86%] mt-4 
               max-xl:w-[74%]
               max-md:w-[73%] '/>
           </div>}
          >           
         ...
         <AccordionItem className='my-4' header={           
          ...
          '>
              ...
              <hr className='border border-gray-100 w-[83%] mt-4 
               max-xl:w-[74%]
               max-md:w-[70%] '/>
            </div>
            }
         ...
         <AccordionItem className='my-4' header={
            ...
            '>
                ...
                <hr className='border border-gray-100 w-[88%] mt-4 
               max-xl:w-[75%]
               max-md:w-[78%] '/>
            </div>
          }
