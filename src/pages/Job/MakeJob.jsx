...
const MakeJob = () => {
  ...
  return (<>
    <form className='bg-red-300 w-[300px] h-[500px] mx-auto ' onSubmit={onSubmit}>
      <input className='bg-neutral-300 border' onChange={()=>setJobTitle()}></input>
      ...
      <button className='bg-neutral-300 border' onChange={()=>setInWork(true)}></button>
      <input className='bg-neutral-300 border' onChange={()=>setCompanyName()}></input>       

      <br/>

      <button className='bg-green' type='submit'>click</button>
    </form>
  </>
